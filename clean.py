...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Pre processamento do audio')
    parser.add_argument('--src_root', type=str, default='wavfiles',
                        help='diretório dos arquivos de audio que serão segmentados')
    parser.add_argument('--dst_root', type=str, default='clean',
                        help='diretório dos arquivos segmentados e limpos')
    parser.add_argument('--delta_time', '-dt', type=float, default=1.0,
                        help='tempo em segundos do audio segmentado')
    parser.add_argument('--sr', type=int, default=16000,
                        help='taxa para reduzir a rezolução do audio')

    parser.add_argument('--fn', type=str, default='teste_clean.wav',
